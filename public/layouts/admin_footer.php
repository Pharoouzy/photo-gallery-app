<footer class="page-footer grey darken-1">
		<div class="container">
          ...
          <div class="footer-copyright">
            ...
            <a class="grey-text text-lighten-4 right" href="https://github.com.com/Pharoouzy"> GitHub</a> 
            <a class="grey-text text-lighten-4 right" href="https://twitter.com/Pharoouzy">Twitter | </a>
            </div>
          </div>
	</footer>
</body>
